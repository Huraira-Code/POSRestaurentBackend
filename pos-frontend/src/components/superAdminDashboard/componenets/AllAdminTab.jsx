...
const AllAdminsTab = ({
  ...
  console.log("admin order 100", adminOrders);
  if (selectedAdmin) {
    return (
              ...
              <div>
                ...
                <div className="mb-6">
                  <input
                    ...
                    className="block w-full pl-3 pr-3 py-2 border border-[#2a2a2a] rounded-lg bg-[#1a1a1a] text-[#f5f5f5] placeholder-[#606060] focus:outline-none focus:ring-2 focus:ring-[#f6b100] focus:border-transparent"
                  />
                  {selectedDate && (
                    <button
                      onClick={() => setSelectedDate("")}
                      className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#606060] hover:text-[#f5f5f5]"
                    >
                      ✕
                    </button>
                  )}
                ...
                {isLoadingOrders ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-[#a0a0a0] mt-4">Loading order data...</p>
                  </div>
                    ...
                    const filteredOrders = adminOrders.filter(
                      (order, index) => {
                        ...
                        const matchesSearch = searchOrderId
                          ? orderId.includes(searchOrderId.toUpperCase())
                          : true;

                        // ✅ Date Filter: from selectedDate 12:00 PM → next day 12:00 PM
                        let matchesDate = true;
                        if (selectedDate) {
                          const startOfRange = new Date(selectedDate);
                          startOfRange.setHours(12, 0, 0, 0); // 12:00 PM of selected date

                          const endOfRange = new Date(selectedDate);
                          endOfRange.setDate(endOfRange.getDate() + 1); // next day
                          endOfRange.setHours(12, 0, 0, 0); // 12:00 PM of next day

                          const orderTime = new Date(order.createdAt);
                          matchesDate =
                            orderTime >= startOfRange && orderTime < endOfRange;
                        }
    ...
    ${order.paymentStatus === "UNPAID" ? "bg-red-900/50 text-red-300" : ""}
  `}
                            ...
                            {hasMoreOrders && !isLoadingOrders && (
                              <div className="flex justify-center mt-6">
                                <button
                                  ...
                                  className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full shadow-md hover:from-blue-700 hover:to-indigo-700 transition-all duration-300"
                                >
                                  Load More Orders
                                </button>
                              </div>
              ...
              <div>
                ...
                {isLoadingCategories ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-[#a0a0a0] mt-2">Loading categories...</p>
                  </div>
            ...
            {adminDetailView === "Items" && (
              <div>
                ...
                {isLoadingItems ? (
                  <div className="text-center py-8">
                    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#60a5fa] mx-auto"></div>
                    <p className="text-[#a0a0a0] mt-2">Loading menu items...</p>
                  </div>
                ) : adminItems.length > 0 ? (
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-2">
                                <button
                                  onClick={() => handleEditMenuClick(adminMenu)}
                                  className="p-2 bg-[#404040] hover:bg-[#505050] rounded text-[#10b981] transition-colors"
                                  title="Edit Menu"
                                >
                                  <FaEdit size={14} />
              ...
              <div>
                ...
                {isLoadingDeals ? (
                                    ...
                                    >
                                      <p className="text-[#f5f5f5] text-sm font-semibold">
                                        ...
                                        <span className="ml-2 text-xs text-[#a0a0a0]">
                                          ...
                                          {customization.maxSelect} selections)
                                        </span>
                                      </p>
                  ...
                  <div className="text-center py-8 bg-[#1a1a1a] rounded-lg">
                    ...
                    <p className="text-[#a0a0a0] mb-4">No deals created yet</p>
                    <button
                      onClick={handleCreateDeal}
                      className="px-6 py-2 bg-[#60a5fa] hover:bg-[#3b82f6] text-white rounded-lg"
                    >
