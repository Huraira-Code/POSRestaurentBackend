...
const DeleteItemModal = ({setShowDeleteItemModal ,setItemToDelete,handleDeleteItem,isDeletingItem , selectedAdmin , itemToDelete}) => {
 console.log("deleting item:" , selectedAdmin)
    return (
